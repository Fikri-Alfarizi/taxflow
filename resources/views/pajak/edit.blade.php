...
<div class="max-w-5xl mt-2 mx-auto">
    <form action="{{ route('pajak.update', $pajak->id) }}" method="POST" class="space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div class="lg:col-span-8 space-y-4 order-2 lg:order-1">
                <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-all">
                    <div class="px-5 py-3 border-b border-slate-50 dark:border-slate-700 bg-slate-50/20 dark:bg-slate-900/10">
                        <h3 class="text-[9px] lg:text-[10px] font-black text-slate-800 dark:text-white flex items-center gap-2 uppercase tracking-widest leading-none">
                            <i class="ph ph-identification-card text-blue-600 text-lg"></i> Profil Identitas Entitas
                        </h3>
                    </div>
                    ...
                    <div class="p-5 lg:p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nama_perusahaan" id="nama_perusahaan" required value="{{ old('nama_perusahaan', $pajak->nama_perusahaan) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="kategori_usaha" id="kategori_usaha" value="{{ old('kategori_usaha', $pajak->kategori_usaha) }}" 
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat_lengkap" id="alamat_lengkap" rows="2" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-bold text-slate-800 dark:text-slate-200 focus:outline-none transition-all">{{ old('alamat_lengkap', $pajak->alamat_lengkap) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-all">
                    <div class="px-5 py-3 border-b border-slate-50 dark:border-slate-700 bg-slate-50/20 dark:bg-slate-900/10">
                        <h3 class="text-[9px] lg:text-[10px] font-black text-slate-800 dark:text-white flex items-center gap-2 uppercase tracking-widest leading-none">
                            <i class="ph ph-users text-blue-600 text-lg"></i> Detail Person-in-Charge (PIC)
                        </h3>
                    </div>
                    <div class="p-5 lg:p-6 grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        <div>
                            ...
                            <input type="text" name="nama_pic" id="nama_pic" value="{{ old('nama_pic', $pajak->nama_pic) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="kontak_pic" id="kontak_pic" value="{{ old('kontak_pic', $pajak->kontak_pic) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-bold text-slate-800 dark:text-slate-200 focus:outline-none transition-all">
                        </div>
                        <div class="md:col-span-2">
                            ...
                            <input type="email" name="email_pic" id="email_pic" value="{{ old('email_pic', $pajak->email_pic) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-bold text-slate-800 dark:text-slate-200 focus:outline-none transition-all">
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-4 space-y-4 order-1 lg:order-2">
                <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-all">
                    ...
                    <div class="p-5 lg:p-6 space-y-4">
                        <div>
                            <label for="jenis_pajak" class="block text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 px-1 leading-none">Jenis Pajak</label>
                            <input type="text" name="jenis_pajak" id="jenis_pajak" required value="{{ old('jenis_pajak', $pajak->jenis_pajak) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-black text-slate-800 dark:text-slate-200 focus:outline-none transition-all">
                        </div>
                        <div>
                            ...
                            <input type="text" name="periode" id="periode" required value="{{ old('periode', $pajak->periode) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-bold text-slate-800 dark:text-slate-200 focus:outline-none transition-all">
                        </div>
                        <div>
                            <label for="kpp_pratama" class="block text-[8px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5 px-1 leading-none">Regional KPP Tax Office</label>
                            <input type="text" name="kpp_pratama" id="kpp_pratama" value="{{ old('kpp_pratama', $pajak->kpp_pratama) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-black text-blue-600 dark:text-blue-400 focus:outline-none transition-all">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm overflow-hidden transition-all">
                    <div class="px-5 py-3 border-b border-slate-50 dark:border-slate-700 bg-slate-50/20 dark:bg-slate-900/10">
                        <h3 class="text-[9px] lg:text-[10px] font-black text-slate-800 dark:text-white flex items-center gap-2 uppercase tracking-widest leading-none">
                            <i class="ph ph-calendar-check text-blue-600 text-lg"></i> Siklus Kepatuhan
                        </h3>
                    </div>
                    <div class="p-5 lg:p-6 space-y-4">
                        <div>
                            ...
                            <input type="date" name="tanggal_input" id="tanggal_input" required value="{{ old('tanggal_input', $pajak->tanggal_input) }}" 
                                class="w-full px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-lg text-[11px] font-bold text-slate-800 dark:text-slate-200 focus:outline-none transition-all">
                        </div>
                        <div>
                            ...
                            <input type="date" name="tanggal_jatuh_tempo" id="tanggal_jatuh_tempo" required value="{{ old('tanggal_jatuh_tempo', $pajak->tanggal_jatuh_tempo) }}" 
                ...
                <div class="pt-4 px-2">
                    <button type="submit" class="w-full flex items-center justify-center gap-3 bg-slate-800 dark:bg-slate-700 hover:bg-black text-white font-black py-3 rounded-2xl shadow-xl shadow-slate-100 dark:shadow-none transition-all text-[10px] tracking-widest uppercase">
                        <i class="ph ph-check-circle text-xl"></i> KOMIT PERUBAHAN MASTER
                    </button>
                    <p class="text-center text-[7px] font-black text-slate-300 dark:text-slate-600 uppercase tracking-[0.2em] mt-4">Audit log akan di-generate secara otomatis</p>
                </div>
            </div>
        </div>
    </form>
